...
class WorldGenerator:
    ...
    def init_template_world(self):
        ...
        # add a plugin to world (if using the 'poles' world, this step is not necessary)
        # plugin = ET.Element('plugin')
        # plugin.attrib['name'] = 'gazebo_octomap'
        # plugin.attrib['filename'] = 'libBuildOctomapPlugin.so'
        # self.world.append(plugin)
